  ...
  <div class="lg:col-span-3 space-y-6">
    <div class="rounded-md border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900">
      <div class="p-5 space-y-4 sm:p-6">
        ...
        <!-- Job Description -->
        <div class="space-y-1">
          <label for="description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Descriptions</label>
          <textarea name="description" id="description" rows="10" class="form-control w-full border rounded-lg p-2">{{ old('description', $job->description ?? '') }}</textarea>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div class="flex items-center space-x-2">
            ...
            <input type="checkbox" name="is_show_salary" value="1" id="is_show_salary" class="rounded"
              @if(isset($job) && $job->is_show_salary) checked @endif>
            <label for="is_show_salary" class="text-sm font-medium text-gray-700 dark:text-gray-300">
              Show Min & Max Salary in Job Listing
            </label>
          </div>
        ...
        <div class="space-y-1">
          ...
          <select name="job_type" id="job_type" class="form-control">
            ...
            <option value="freelance" @if(isset($job) && $job->job_type === 'freelance') selected @endif>Freelance</option>
      ...
      <div class="p-3 space-y-2 sm:p-4">
        ...
        <div class="space-y-1">
          ...
          <input type="text" name="published_at" id="published_at" class="form-control"
            value="{{ old('published_at', isset($job) ? ($job->published_at ? $job->published_at->format('Y-m-d') : '') : '') }}">
        </div>
